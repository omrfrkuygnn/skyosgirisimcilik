...
public sealed class ContactMessagesController : AdminControllerBase
{
    ...
    public ContactMessagesController(
        IContactMessageAdminService service,
    ...
    public async Task<IActionResult> Details(int id, CancellationToken cancellationToken)
    {
        ...
        await LogActionAsync(AuditActions.ViewContactMessage, "ContactMessage", id.ToString()).ConfigureAwait(false);
    ...
    public async Task<IActionResult> Reply(int id, [Bind(Prefix = "")] AdminReplyDto reply, CancellationToken cancellationToken)
    {
        ...
        var result = await _replyService
            .ReplyToContactAsync(id, reply, adminEmail, adminName, cancellationToken)
        ...
        await LogActionAsync(
            AuditActions.ReplyContactMessage,
            "ContactMessage",
            id.ToString(),
    ...
    {
        await _service.MarkAsReadAsync(id, cancellationToken).ConfigureAwait(false);
        await LogActionAsync(AuditActions.MarkContactRead, "ContactMessage", id.ToString()).ConfigureAwait(false);
    ...
    public async Task<IActionResult> Delete(int id, CancellationToken cancellationToken)
    {
        ...
        await LogActionAsync(AuditActions.DeleteContactMessage, "ContactMessage", id.ToString()).ConfigureAwait(false);
        return RedirectToAction(nameof(Index));
    }
}
